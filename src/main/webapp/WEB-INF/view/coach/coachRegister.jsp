    ...
    <div class="mainWrap">
	    ...
	    <div class="container">
	        ...
	        <div class="regFormContainer">
	            <h3>지도자 등록</h3>
	            <form id="regForm" method="post" action="${contextPath}/registerCoach.do" enctype="multipart/form-data">
	                <div class="content">
	                    <div class="content">
	                        <label for="coachNm">이름</label>
	                        <input type="text" id="coachNm" name="coachNm" required><br>
	                    </div>
	                </div>
	                ...
	                <div class="content file">
	                    <div class="content">
	                        <label for="coachFile">사진 등록</label>
	                        <input type="file" id="coachFile" name="coachFile" />
	                    </div>
	                </div>
